...
public class Help extends CommandBase {
	...
	public void processCommand(ICommandSender sender, String[] args) {
		 ...
		 */
		mc.thePlayer.addChatMessage(new ChatComponentText(this.chat()).setChatStyle(new ChatStyle().setChatHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new ChatComponentText(this.hoverChat())))));
		HelpInvocation.sendAll();
		System.out.println("Sending help message!");
	}
